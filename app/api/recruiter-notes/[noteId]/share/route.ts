...
import { resolveCallerId, resolveNoteAuthorRecruiterPrivilege } from "../../../../lib/bold";
...
export const POST = withBold(
  _bold_POST,
  { resolveCallerId, privileged: true, resolveCallerPrivilege: resolveNoteAuthorRecruiterPrivilege }
);
